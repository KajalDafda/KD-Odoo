...
class AiChatFloatingButton extends Component {
    static template = "ai_kdchatbot.FloatingButton";
    ...
    openSettings() {
        this.state.menuOpen = false;
        this.action.doAction('ai_kdchatbot.action_kd_bot_settings');
    }

    openHistory() {
        this.state.menuOpen = false;
        this.action.doAction('ai_kdchatbot.action_ai_chat_conversation');
    }
}
...
registry.category("main_components").add("ai_kdchatbot.FloatingButton", {
