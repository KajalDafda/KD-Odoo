...
class AiChatConversation(models.Model):
    ...
    name = fields.Char(
        ...
        help="Name of the AI chat conversation.",
    )
    ...
    message_ids = fields.One2many(
        ...
        'conversation_id',
        string='Messages',
        help="Messages exchanged in this conversation.",
    )
    ...
    def _get_config(self):
        ...
        provider = icp.get_param('ai_chatbot.provider', 'anthropic')
        api_key = icp.get_param('ai_chatbot.api_key')
        api_url = icp.get_param('ai_chatbot.api_url') or DEFAULT_ENDPOINTS.get(provider)
        ...
        model = icp.get_param('ai_chatbot.model_custom') or icp.get_param('ai_chatbot.model')
    ...
    def _check_model_allowed(self, model_name):
        ...
        ai_chatbot.allowed_models system parameter is empty, all models the
        ...
        icp = self.env['ir.config_parameter'].sudo()
        allowlist_raw = icp.get_param('ai_chatbot.allowed_models', '')
